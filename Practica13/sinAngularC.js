...
function checkRespuesta(){
    ...
    for (var i = 0, length = radios.length; i < length; i++) {
        ...
        if (radios[i].checked) {
            ...
            xmlHttp.open("GET", "resp.php?respuesta="+value+"", true);
...
function ajaxRutaImagen(){
    ...
    // url destino + parámetros
    xmlHttp.open("GET", "resp.php?ruta=si", true);
    xmlHttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
function ajaxPista(){
    ...
    // url destino + parámetros
    xmlHttp.open("GET", "resp.php?pista=si", true);
    xmlHttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
function ajaxPregunta(){
    ...
    // url destino + parámetros
    xmlHttp.open("GET", "resp.php?pregunta=si", true);
    xmlHttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
