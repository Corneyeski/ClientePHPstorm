    ...
    <body>
        ...
        <div id="cuerpop">
            <div  id="cuerpo">
                ...
                <?php
                $consulta = mysql_query("SELECT id_concierto,nombre,fecha,precio,duracion,asistentes,disponibilidad,id_local FROM concierto inner join apunta"
                        . " WHERE disponibilidad = 'si' and $id != apunta.id_grupo  ", $conexion) or die("No se encuentran datos");
