            ...
            <div  id="cuerpo">
                <div id='cssmenup'>
                    <ul>
                        ...
                        <li class="active"><a href='localca.php'>Conciertos abiertos</a></li>
                        <li><a href='localcc.php'>Conciertos cerrados</a></li>
                        <li><a href='localcr.php'>Crear concierto</a></li>
                    </ul>
                </div>
                <h2>Conciertos abiertos para apuntarse</h2>
                <?php
                $consulta = mysql_query("SELECT apunta.id_concierto,nombre,fecha,precio,duracion,asistentes,disponibilidad,id_local FROM concierto inner join apunta"
                        . " WHERE  '$id' = apunta.id_grupo ", $conexion) or die("No se encuentran datos");
                ...
                while ($row = mysql_fetch_array($consulta)) {
                    ...
                    $consulta2 = mysql_query("SELECT direccion FROM usuarios WHERE '$idl' = id_usuario", $conexion) or die("No se encuentran datos");
                    ...
                    <div id="conciertosa">
                        ...
                        <div>
                            ...
                            <div class="apuntarse"><?php echo "<a href='apuntarse.php?idc=$id2&id=$id'>apuntarse</a>" ?></div>
                        </div><div class="mapa">
                        </div>
                        <script>
                            $(document).ready(init);
