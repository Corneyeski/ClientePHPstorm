    ...
    <body>
        ...
        <div id="cuerpop">
            <div  id="cuerpo">
                <div id='cssmenup'>
                    <ul>
                        <li><a href="../buscar.php">Musicos</a></li>
                        <li><a href='buscarl.php'>Locales</a></li>
                        <li  class='active'><a href='buscarc.php'>Conciertos</a></li>
                    </ul>
                </div>
                <div>
                    <h1>Conciertos</h1>
                    ...
                    $consulta = mysql_query("SELECT nombre,id_local FROM conciertos WHERE '$buscar' = nombre", $conexion) or die("No se encuentran datos");
