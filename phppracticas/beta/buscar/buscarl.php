            ...
            <div  id="cuerpo">
                <div id='cssmenup'>
                    <ul>
                        ...
                        <li  class='active'><a href='buscarl.php'>Locales</a></li>
                        <li><a href='buscarc.php'>Conciertos</a></li>
                    </ul>
                </div>
                <div>
                    <h1>Locales</h1>
                    ...
                    $consulta = mysql_query("SELECT nombre FROM usuarios WHERE '$buscar' = nombre and tipo = 1", $conexion) or die("No se encuentran datos");
